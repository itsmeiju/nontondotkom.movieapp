package com.izzu.nontondotkom.checkout
...
import com.izzu.nontondotkom.home.TiketActivity
...
class CheckoutActivity : AppCompatActivity() {
    ...
    private fun showNotif(datas: Film) {
        val NOTIFICATION_CHANNEL_ID = "channel_nontondotkom_notif"
        val context = this.applicationContext
        var notificationManager =
            context.getSystemService(NOTIFICATION_SERVICE) as NotificationManager

        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            val channelName = "nontondotkom Notif Channel"
...
//        mIntent.putExtras(bundle)
        ...
        builder.setContentIntent(pendingIntent)
            .setSmallIcon(R.drawable.nontondotkom)
            .setLargeIcon(
                BitmapFactory.decodeResource(
                    this.resources,
                    R.drawable.nontondotkom
                )
            )
            .setTicker("notif nontondotkom starting")
            .setAutoCancel(true)
