...
import com.izzu.nontondotkom.home.dashboard.ComingSoonAdapter
import com.izzu.nontondotkom.home.dashboard.TodayAdapter
...
class TiketFragment : Fragment() {
    ...
    private var dataList = ArrayList<Today>()
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference("Today")
        ...
        mDatabase.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                for (getdataSnapshot in dataSnapshot.getChildren()) {
                    ...
                    val today = getdataSnapshot.getValue(Today::class.java!!)
                    dataList.add(today!!)
                }
